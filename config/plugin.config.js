      ...
      .use(ThemeColorReplacer, [
        {
          ...
          // Main color series
          // Change style selector，Solve style coverage issues
...
const getAntdSerials = color => {
  const lightNum = 9;
  const devide10 = 10; // Lighten（That is less tint）
  ...
  const rgb = ThemeColorReplacer.varyColor.toNum3(color.replace('#', ''))
    .join(',');
